...
// Atterrissage quand /commission/[token] ne reconnaît pas le jeton (lien
// mal copié, lien régénéré depuis "Accès Commissions & Administration") —
// même ton que /benevole/erreur.
export default function CommissionErreurPage() {
  return (
